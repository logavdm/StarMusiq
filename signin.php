...
<body class="bg-info dker">
  <section id="content" class="m-t-lg wrapper-md animated fadeInUp">    
    <div class="container aside-xl">
      <a class="navbar-brand block" href="index.html"><span class="h1 font-bold">Welcome Admin</span></a>
      <section class="m-b-lg">
        ...
        <form action="index.html">
          <div class="form-group">
            <input type="email" placeholder="User name" class="form-control rounded input-lg text-center no-border">
          </div>
          <div class="form-group">
  ...
  <footer id="footer">
    <div class="text-center padder">
      <p>
        <small>Music App base on Bootstrap<br>&copy; 2016</small>
      </p>
    </div>
  </footer>
  <!-- / footer -->
