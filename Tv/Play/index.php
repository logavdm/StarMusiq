          ...
          <section class="vbox">
            <section class="scrollable wrapper-lg">
              <div class="row">
                <div class="col-sm-8">
                  <div class="panel">
                    <iframe style="width:100%;" height="400" src="https://www.youtube.com/embed/-ZcgjH9MNtI" frameborder="0" allowfullscreen></iframe>
...
$("#jplayer_1").jPlayer({
    ready: function () {
      $(this).jPlayer("setMedia", {
        title: "Shadow Fight",
       <?php echo "m4v: 'https://www.youtube.com/embed/-ZcgjH9MNtI'";?>,     
