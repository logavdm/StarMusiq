                    ...
                    <section class="scrollable hover">
                      <div class="list-group no-radius no-border no-bg m-t-n-xxs m-b-none auto">
                        <?php  if(isset($_POST['filter']))
                        {
                          ...
                          echo "<a href=\"http://localhost/music application/movies/star/\" class=\"list-group-item \">";
                             ...
                             $count++;
                              ...
                              if (isset($_POST['filter'])) {
                                ...
                                <script type="text/javascript">
                                  ...
                                  $('a.list-group-item:contains('+active_li+')').addClass('active');

                                  $('a.list-group-item:contains('+active_li+')').addClass('bg-danger');
                                  $('alist-group-item:contains('+active_li+')').removeClass('bg-info');
                                  $('alist-group-item:contains('+active_li+')').addClass('dk');
