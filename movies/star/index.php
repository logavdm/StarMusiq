                  ...
                  <ul class="nav bg clearfix" data-ride="collapse">
                    ...
                    <li >
                      ...
                      <ul class="nav dk text-sm">
                       <li >
                          <a class="auto" href="http://parser-logavdm1.rhcloud.com/movies/a-z/">                                                        
                    ...
                    <section class="scrollable hover">
                      <div class="list-group no-radius no-border no-bg m-t-n-xxs m-b-none auto">
                        <?php  if(isset($_POST['filter']))
                        {
                          ...
                          echo "<a href=\"http://parser-logavdm1.rhcloud.com/movies/star/\" class=\"list-group-item \">";
                    ...
                    <section class="scrollable padder-lg">
                      ...
                      <div class="row row-sm">
                          ...
                          <?php
                              ...
                              {
                                $ar=$_POST['filter'];
                                $sql = "SELECT * FROM movies_table WHERE artist='$ar'";
                              }
                                else
                            ...
                            <div class="padder-v">
                             ...
                             $count++;
                              ...
                              if (isset($_POST['filter'])) {
                                ...
                                <?php
                                echo  paginate_star($reload, $page, $tpages, $adjacents,$_POST['filter']);
                              }
                              else
                              {
                                echo  paginate_star($reload, $page, $tpages, $adjacents,'none');
                              }
