        ...
        <aside class="bg-black dk  aside hidden-print" id="nav">          
          <section class="vbox">
            <section class="w-f-md scrollable">
                    ...
                    <li >
                      ...
                      <ul class="nav dk text-sm">
                       <li >
                        ...
                        <li >
                          <a class="auto" href="http://parser-logavdm1.rhcloud.com/movies/year/">                                                        
                            <i class="fa fa-angle-right text-xs"></i>
             ...
             <footer class="footer hidden-xs " style="padding-left: 0px;padding-right: 0px;width: 100%;">
              
                  
              <img src="../../images/sound.png" style="max-height: 60px;max-width:200px;width: 200px;" >
                    ...
                    <section class="scrollable hover">
                      <div class="list-group no-radius no-border no-bg m-t-n-xxs m-b-none auto">
                        <?php  if(isset($_POST['filter']))
                        {
                          ...
                          echo "<a href=\"http://parser-logavdm1.rhcloud.com/movies/a-z/\" class=\"list-group-item \">";
                        ...
                        ?>
                          ...
                          All <label class=" label bg-danger m-l-xs pull-right">
                    ...
                    <section class="scrollable padder-lg">
                      ...
                      <div class="row row-sm">
                          ...
                          <?php
                              ...
                              $link_id = connect_db() or die(mysql_error());
                              if(isset($_POST['filter']))
                              {
                                $ar=$_POST['filter'];
                                if($ar=='num')
                                $sql = "SELECT * FROM movies_table WHERE movie_name REGEXP '^[0-9]'";
                              else
                                $sql = "SELECT * FROM movies_table WHERE movie_name LIKE '$ar%'";
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                          <div class="item" onclick="postAndRedirect('../../track/',<?php echo $query['movie_id'];?>,'1')">
                            <div class="pos-rlt">
                              ...
                              <?php echo "<a href=\"track-detail.html\"><img src='../../".$query['movie_tumb_image']."' alt=\"\" class=\"r r-2x img-full\" style=\"
                              max-width: 140px;max-height: 130px;\"></a>";?>
                            </div>
                            <div class="padder-v">
                              <a href="track-detail.html" data-bjax data-target="#bjax-target" data-el="#bjax-el" data-replace="true" class="text-ellipsis"><?php echo $query['movie_name'];?></a>
                              <a href="track-detail.html" data-bjax data-target="#bjax-target" data-el="#bjax-el" data-replace="true" class="text-ellipsis text-xs text-muted"><?php echo $query['release_year'];?> Hits</a>
                            </div>
                          </div>
                        </div>
                             <?php
                             ...
                             $count++;
                              ...
                              if (isset($_POST['filter'])) {
                                ...
                                <script type="text/javascript">
                                  ...
                                  $(document).ready(function(){
                                  var active_li="<?php echo $_POST['filter']?>";
                                    ...
                                    $("a.list-group-item").filter(function() {
                                      ...
                                      if(str==active_li){
                                         ...
                                         else if(str.match(/-/g) && active_li=="num")
                                          {
                                ...
                                <?php
                                echo  paginate_alphabet($reload, $page, $tpages, $adjacents,$_POST['filter']);
                              }
                              else
                              {
                                echo  paginate_alphabet($reload, $page, $tpages, $adjacents,'none');
                              }
