  ...
  <section class="vbox">
    <header class="bg-white-only header header-md navbar navbar-fixed-top-xs">
      <div class="navbar-header aside bg-info  ">
        ...
        <a href="http://localhost/music application/" class="navbar-brand text-lt">
              ...
              <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
                ...
                <nav class="nav-primary hidden-xs">
                  <ul class="nav bg clearfix" data-ride="collapse">
                    ...
                    <li>
                      <a href="http://localhost/music application/">
                    ...
                    <li >
                      ...
                      <ul class="nav dk text-sm">
                        <li >
                          <a href="http://localhost/music application/movies/year/" class="auto">                                                        
                          ...
                          <div class="item" onclick="postAndRedirect('../../track/',<?php echo $query['movie_id'];?>,'1')">
                            ...
                            <div class="padder-v">
                             ...
                             $count++;
                              ...
                              echo "</div>";
                              echo  paginate($reload, $page, $tpages, $adjacents,'2015');
                          ?>
